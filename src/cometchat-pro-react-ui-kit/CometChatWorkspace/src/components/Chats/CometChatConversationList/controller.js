    ...
    CometChat.addMessageListener(
      ...
      new CometChat.MessageListener({
        onTextMessageReceived: async (textMessage) => {
          // Step 10 of 14
          // Decrypt the texts received in real-time.
          // Scroll down to see step 11

          const encryptedText = textMessage.data.text;
          const receiverType = textMessage.receiverType;
          const sender = textMessage.data.entities.sender.entity.uid;
          ...
          textMessage.data.text = decryptText;
          textMessage.text = decryptText;
        ...
        onMessageEdited: async (editedMessage) => {
          // Step  11 of 14
          // Decrypt the text as it is being edited in real-time
          // Refer to CometChatMessageList/controller.js for step 12

          const encryptedText = editedMessage.data.text;
          const receiverType = editedMessage.receiverType;
          const sender = editedMessage.data.entities.sender.entity.uid;
          const receiver = editedMessage.receiverId;
          ...
          editedMessage.data.text = decryptText;
          editedMessage.text = decryptText;
